        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Botón para ver ganancias por mes
              Container(
                width: double.infinity,
                child: ElevatedButton.icon(
                  onPressed: () {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => const ProfitHistoryScreen(),
                      ),
                    );
                  },
                  icon: const Icon(Icons.trending_up),
                  label: const Text('Ver Ganancias por Mes'),
                  style: ElevatedButton.styleFrom(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          'Total: ${NumberFormat.currency(symbol: '\$', decimalDigits: 2).format(_dataManager.totalMonthlyExpenses)}',
                          style: Theme.of(context).textTheme.titleMedium?.copyWith(
