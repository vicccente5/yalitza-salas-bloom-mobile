-- =====================================================================
-- CORRECCIÓN COMPLETA PARA VISTAS FINANCIERAS
-- Problema: monthly_profits_with_expenses muestra 0.00 en total_expenses
-- =====================================================================

-- 0. ELIMINAR VISTAS EXISTENTES PARA PODER RECREARLAS
DROP VIEW IF EXISTS monthly_profits_with_expenses;
...
-- con los gastos reales calculados desde la tabla expenses
...
SELECT 
    ...
    -- Calcular gastos en tiempo real desde la tabla expenses
    COALESCE(
        (
            SELECT SUM(monto)
            FROM expenses e
